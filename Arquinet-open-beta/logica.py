...
# -*- coding: utf-8 -*-
"""
Quintikus DLMC V85.2 + DSML + Curiosity + Sentimento + Metacognitivo (Refinado)
...
Versão Final – Com Gatilho por Turnos e Modulação de Temperatura
"""
...
if __name__ == "__main__":
    ...
    if os.path.exists("amor.txt"):
        ...
        print(f"📁 amor.txt carregado ({len(texto_inicial)} caracteres).")
